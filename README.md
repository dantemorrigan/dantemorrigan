...
### 🤖 Разработчик Telegram-бота — 48-91KINO_bot
- Создал кино-бота с фильтрами и поиском по категориям  
- Бот интегрирован с телеграм-каналом, исходный код доступен на GitHub

### 🗒️ Разработчик open-source приложения — Cotes
- Легковесное приложение для заметок с простым UI и локальным хранилищем  
- Полностью open-source, доступно на GitHub
